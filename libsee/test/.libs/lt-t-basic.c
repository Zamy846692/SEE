...
/* ./.libs/lt-t-basic.c - temporary wrapper executable for .libs/t-basic.exe
   Generated by ltmain.sh (GNU libtool) 2.2.4 Debian-2.2.4-0ubuntu4

   The t-basic program cannot be directly executed until all the libtool
   libraries that it depends on are installed.

   This wrapper executable should never be moved out of the build directory.
   If it is, it will not operate correctly.

   Currently, it simply execs the wrapper *script* "/bin/sh t-basic",
   but could eventually absorb all of the scripts functionality and
   exec .libs/t-basic.exe directly.
*/
#include <stdio.h>
#include <stdlib.h>
#ifdef _MSC_VER
...
static const char *script_text =
  "#! /bin/sh\n"
  "\n"
  "# t-basic - temporary wrapper script for .libs/t-basic.exe\n"
  "# Generated by ltmain.sh (GNU libtool) 2.2.4 Debian-2.2.4-0ubuntu4\n"
  "#\n"
  "# The t-basic program cannot be directly executed until all the libtool\n"
  "# libraries that it depends on are installed.\n"
